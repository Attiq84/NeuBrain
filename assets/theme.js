...
if (console && console.log) {
  console.log('Dawn ('+theme.settings.themeVersion+') by Shopify | Learn more at https://themes.shopify.com/');
}
...
(function(){
  ...
  if (window.Shopify && window.Shopify.theme && navigator && navigator.sendBeacon && window.Shopify.designMode) {
    navigator.sendBeacon('https://www.shopify.com/', new URLSearchParams({
      ...
      themeStoreId: window.Shopify.theme.theme_store_id || 887,
